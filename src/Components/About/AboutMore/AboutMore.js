      ...
      <div className="container mt-5">
        ...
        <div className="row py-5">
          ...
          <div className="col-lg-8 col-md-6 col-12  mt-5 mt-md-0 mt-lg-0">
            ...
            >
              <p>
                My name is Anik Deb nath from Chittagong,Bangladesh. I am a Web
                Developer also student of CSE Dept. I am passionate about
                learning and development with a desire to apply skills to a
                larger development team to tackle more complex problems and
                continue to find ways to maximize user efficiency.
              </p>
              <p>
                Talented with many technologies including HTML5, CSS3,
                Javascript , React , Next Js, Tailwind , Material Ui, Node js,
                Express Js, Firebase and so on. My work is of highest quality,
                fully responsive, and tested on many devices.
              </p>
              <p>
                Completed a long time training form Programming-hero where I
                finished 12+ project successfully. Worked to build a multivendor
                eCommerce site with git collaboration in a team - winningdev in
              ...
              {skills.map((skill) => (
                ...
                >
                  <Card
                    ...
                    className="rounded-circle mx-2 my-3 border shadow"
                  >
                    <img
                      loading="lazy"
            ...
            <Row className="p-3">
              <Col md={6} sm={6}>
                <div className="card text-black p-4 mb-4 shadow">
                  ...
                  <p>
                    <span className="text-success fw-bold">Present -</span> B.sc
                    in CSE
                  </p>
                </div>
              </Col>
              <Col md={6} sm={6}>
                <div className="card text-black p-4 mb-4 shadow">
                  ...
                  <p>
                    <span className="text-success fw-bold">2018-</span> Higher
              ...
              <Col md={6} sm={6}>
                <div className="card text-black p-4 mb-4 shadow">
                  <h6 className="fw-bold">
                    Jafar Nagar A.C High School, Sitakund, Chittagong
                  </h6>
                  <p>
                    <span className="text-success fw-bold">2016-</span>{" "}
        ...
        <div className="row">
          <div className="col-lg-6 mx-auto text-center mb-3 m-1">
            <img
              ...
              src="https://i.ibb.co/YhFmvf7/certificate-1.jpg"
              alt=""
            />
          </div>
          <div className="col-lg-6 mx-auto text-center mb-3 m-1">
