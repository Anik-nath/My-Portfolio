        ...
        <div id="section-header" className="row">
          <div className="col-12">
            <h2 className="position-relative pb-5 my-title">
              What I Do?
              <span className="position-absolute start-0 bottom-50 mb-2 text-uppercase">
                Services
              </span>
            </h2>
          </div>
        ...
        <div id="section-content">
          <Row>
            <Col
              ...
              sm={12}
            >
              <div style={{ width: "160px", heigth: "160px" }}>
                <img className="w-100" src={services1} alt="services logo" />
              </div>
              <div className="ms-4 w-100">
                <h5 className="light-base-text">Web Development</h5>
                <p className="mb-0 light-base-text text-justify pt-1">
                  Build Web application with using React or NextJs, Tailwind or
                  MUI With NodeJS, MongoDB.
                </p>
              </div>
            </Col>
            <Col
              data-aos="fade-up"
              className="d-flex flex-row align-items-center my-lg-0 my-5"
              md={4}
              sm={12}
            >
              <div style={{ width: "160px", heigth: "160px" }}>
              ...
              <div className="ms-4 w-100">
                ...
                <p className="mb-0 light-base-text text-justify pt-1">
                  Fix Website error or Bug or any issue and provide solution for
                  your web appliction.
                </p>
              </div>
            </Col>
            ...
            >
              ...
              <div className="ms-4 w-100">
                ...
                <p className="mb-0 light-base-text text-justify pt-1">
                  Design unique and responsive web application using html5,
                  CSS3, Bootstrap5.
                </p>
              </div>
            </Col>
