            ...
            <Row>
                <Col className="d-flex flex-row align-items-center" md={4} sm={12}>
                    ...
                    <div className="text-white ms-4">
                        ...
                        <p className="mb-0 text-white-50 text-justify pt-1">Build Web application with using React or NextJs, Tailwind or MUI With NodeJS, MongoDB.</p>
                    </div>
                </Col>
                <Col className="d-flex flex-row align-items-center my-lg-0 my-5" md={4} sm={12}>
                    ...
                    <div className="text-white ms-4">
                        <h5>Web Solution</h5>
                        <p className="mb-0 text-white-50 text-justify pt-1">Fix Website error or Bug or any issue and provide solution for your web appliction.</p>
                    </div>
                </Col>
                <Col className="d-flex flex-row align-items-center" md={4} sm={12}>
                    <div style={{width: "250px", heigth:"250px"}}>
                    ...
                    <div className="text-white ms-4">
                        <h5>Web Design</h5>
                        <p className="mb-0 text-white-50 text-justify pt-1">Design unique and responsive web application using html5, CSS3, Bootstrap5.</p>
                    </div>
                </Col>
            </Row>
        </div>
